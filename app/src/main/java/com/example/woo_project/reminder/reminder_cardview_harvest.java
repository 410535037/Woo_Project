...
public class reminder_cardview_harvest {
    ...
    public reminder_cardview_harvest(){
        super();
    }

    public reminder_cardview_harvest(String id, String vege_img, String name, String tag1, String tag2,String unit,
