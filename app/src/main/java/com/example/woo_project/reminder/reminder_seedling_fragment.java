        ...
        public void run() {
            ...
            switch (main_reminder.time_range_sp.getSelectedItemPosition())
            {
                ...
                case 4:
                    ...
                    reminder_seedling_data = reminder_webservice.reminder_custom_seedling_data_list("39",main_reminder.StartDateTiet.getText().toString(),main_reminder.EndDateTiet.getText().toString());
                    mUI_Handler.post(setReminder_seedling_data);
                    break;
                default:
                    break;
