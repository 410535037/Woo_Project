...
public class reminder_cardview_planting {
    ...
    public reminder_cardview_planting(){
        super();
    }

    public reminder_cardview_planting(String id, String vege_img, String name, String tag1, String tag2,String unit,
                             String check_img, String vendor, String remark, String preharvest, String pregrowing, int preday_num, int pregrowing_num, String canopy_name)
    {
        super();
        this.id = id;
    ...
    public void setCanopy_name(String canopy_name){ this.canopy_name = canopy_name;}
    public String getCanopy_name(){return canopy_name;}
