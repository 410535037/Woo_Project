...
//        mTextTitle = (TextView) root.findViewById(R.id.text_title_home);
        ...
        remind_rv.setAdapter(new threeFragment.threeFragmentadapter(getActivity(), remindList));
...
//        remind_rv.setLayoutManager(new StaggeredGridLayoutManager(1, StaggeredGridLayoutManager.VERTICAL));
//        remind_rv.setHasFixedSize(true);
//        remind_rv.setAdapter(new threeFragment.oneFragmentadaper(getActivity(), remindList));
//
//        remindList.add(new remind_cardview(1,"胡蘿蔔",R.drawable.carrot, "育苗日 : 今日","20盤",false));
//        remindList.add(new remind_cardview(2,"胡蘿蔔",R.drawable.carrot, "育苗日 : 今日","20盤",false));
//        remindList.add(new remind_cardview(3,"胡蘿蔔",R.drawable.carrot, "育苗日 : 今日","20盤",false));
...
//        remindList.add(new remind_cardview(8,"胡蘿蔔",R.drawable.carrot, "育苗日 : 今日","20盤",false));
    ...
    private class threeFragmentadapter extends RecyclerView.Adapter<threeFragmentadapter.viewholder>  {

        private Context mctx;
        private List<remind_cardview> remindList;
        String s="";
        public threeFragmentadapter(Context mctx, List<remind_cardview> remindList) {
            this.mctx = mctx;
            this.remindList = remindList;
        }

        @Override
        public threeFragmentadapter.viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            LayoutInflater inflater=LayoutInflater.from(mctx);
            View view=inflater.inflate(R.layout.remind_cardview,viewGroup,false);
            return new threeFragmentadapter.viewholder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull threeFragmentadapter.viewholder holder, int position) {
